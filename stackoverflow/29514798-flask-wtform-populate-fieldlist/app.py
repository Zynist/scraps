...
def addclass():
    ...
    print classform.name.data
    print "###"
    print classform.students.data
...
def PopulateFormFromFile():
    ...
    for student_id, name in student_info:
        ...
        student_data_array.append({'student_id': student_id, 'student_name': name})
        classform.students.append_entry(studentform)

    print "~~~"
    print student_data_array

    print "++++++ Now printing out students data iteratively."
    for student in classform.students:
        print "* " + student.student_id.data + " - " + student.student_name.data
    print "++++++ ----" 
    #classform.students.data = student_data_array
    return classform
